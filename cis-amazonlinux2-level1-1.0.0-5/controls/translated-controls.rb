...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.1.2_Ensure_mounting_of_hfs_filesystems_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.1.3_Ensure_mounting_of_hfsplus_filesystems_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.1.4_Ensure_mounting_of_squashfs_filesystems_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.1.5_Ensure_mounting_of_udf_filesystems_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.2_Ensure__tmp_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.18_Ensure_sticky_bit_is_set_on_all_world-writable_directories" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.1.19_Disable_Automounting" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.2.3_Ensure_gpgcheck_is_globally_activated" do
  ...
  describe files.delete_if { |f| command("file #{f} | cut -d: -f2").stdout =~ /binary|executable|archive/ || file(f).content !~ /^\s*gpgcheck\s*=\s*[^1]\s*(\s+#.*)?$/ } do
    it { should be_empty }
  end
...
control "xccdf_org.cisecurity.benchmarks_rule_1.4.2_Ensure_authentication_required_for_single_user_mode" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.5.2_Ensure_address_space_layout_randomization_ASLR_is_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.5.3_Ensure_prelink_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_1.7.1.1_Ensure_message_of_the_day_is_configured_properly" do
  ...
  describe file("/etc/motd") do
    its("content") { should_not match(/(\\v|\\r|\\m|\\s|(?i)(Amazon))/) }
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.1.1_Ensure_time_synchronization_is_in_use" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.1.2_Ensure_ntp_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.1.3_Ensure_chrony_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.2_Ensure_X_Window_System_is_not_installed" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.3_Ensure_Avahi_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.4_Ensure_CUPS_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.5_Ensure_DHCP_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.6_Ensure_LDAP_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.7_Ensure_NFS_and_RPC_are_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.8_Ensure_DNS_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.9_Ensure_FTP_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.10_Ensure_HTTP_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.11_Ensure_IMAP_and_POP3_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.12_Ensure_Samba_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.13_Ensure_HTTP_Proxy_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.14_Ensure_SNMP_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.15_Ensure_mail_transfer_agent_is_configured_for_local-only_mode" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.16_Ensure_NIS_Server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.17_Ensure_rsh_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.18_Ensure_telnet_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.19_Ensure_tftp_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.20_Ensure_rsync_service_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.1.21_Ensure_talk_server_is_not_enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.1_Ensure_NIS_Client_is_not_installed" do
  ...
  desc  "
    The Network Information Service (NIS), formerly known as Yellow Pages, is a client-server directory service protocol used to distribute system configuration files. The NIS client ( ypbind ) was used to bind a machine to an NIS server and receive the distributed config2uration files.
...
control "xccdf_org.cisecurity.benchmarks_rule_3.1.1_Ensure_IP_forwarding_is_disabled" do
  ...
  describe.one do
    describe file("/etc/sysctl.conf") do
      its("content") { should match(/^\s*net.ipv6.conf.all.forwarding\s*=\s*0$/) }
    end
    files = command("find /etc/sysctl.d -type f -regex .\\*/.\\*").stdout.split
    describe files.delete_if { |f| command("file #{f} | cut -d: -f2").stdout =~ /binary|executable|archive/ || file(f).content !~ /^\s*net.ipv6.conf.all.forwarding\s*=\s*0$/ } do
      it { should_not be_empty }
    end
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_3.2.2_Ensure_ICMP_redirects_are_not_accepted" do
  ...
  describe.one do
    describe file("/etc/sysctl.conf") do
      its("content") { should match(/^\s*net.ipv4.conf.default.accept_redirects\s*=\s*0$/) }
    end
    files = command("find /etc/sysctl.d -type f -regex .\\*/.\\*").stdout.split
    describe files.delete_if { |f| command("file #{f} | cut -d: -f2").stdout =~ /binary|executable|archive/ || file(f).content !~ /^\s*net.ipv4.conf.default.accept_redirects\s*=\s*0$/ } do
      it { should_not be_empty }
    end
  end
...
control "xccdf_org.cisecurity.benchmarks_rule_3.2.7_Ensure_Reverse_Path_Filtering_is_enabled" do
  ...
  desc  "
    Setting net.ipv4.conf.all.rp_filterand net.ipv4.conf.default.rp_filter to 1 forces the Linux kernel to utilize reverse path filtering on a received packet to determine if the packet was valid. Essentially, with reverse path filtering, if the return packet does not go out the same interface that the corresponding source packet came from, the packet is dropped (and logged if log_martians is set).
...
control "xccdf_org.cisecurity.benchmarks_rule_3.3.1_Ensure_TCP_Wrappers_is_installed" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.3.2_Ensure_etchosts.allow_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.3.3_Ensure_etchosts.deny_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.3.4_Ensure_permissions_on_etchosts.allow_are_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.3.5_Ensure_permissions_on_etchosts.deny_are_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.4.1_Ensure_DCCP_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.4.2_Ensure_SCTP_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.4.3_Ensure_RDS_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.4.4_Ensure_TIPC_is_disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.1.1_Ensure_default_deny_firewall_policy" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.1.2_Ensure_loopback_traffic_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.1.3_Ensure_outbound_and_established_connections_are_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.1.4_Ensure_firewall_rules_exist_for_all_open_ports" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.2.1_Ensure_IPv6_default_deny_firewall_policy" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.2.2_Ensure_IPv6_loopback_traffic_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.2.3_Ensure_IPv6_outbound_and_established_connections_are_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.2.4_Ensure_IPv6_firewall_rules_exist_for_all_open_ports" do
...
control "xccdf_org.cisecurity.benchmarks_rule_3.5.3_Ensure_iptables_is_installed" do
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.2_Ensure_permissions_on_SSH_private_host_key_files_are_configured" do
  ...
  "
  impact 1.0
  files = command("find /etc/ssh -regex .*ssh_host.*_key").stdout.split
  if files.empty?
    describe files do
      it { should be_empty }
    end
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.3_Ensure_permissions_on_SSH_public_host_key_files_are_configured" do
  ...
  "
  impact 1.0
  files = command("find /etc/ssh -regex .*ssh_host.*_key.pub").stdout.split
  if files.empty?
    describe files do
      it { should be_empty }
    end
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.4_Ensure_SSH_Protocol_is_set_to_2" do
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.13_Ensure_only_strong_ciphers_are_used" do
  ...
  impact 1.0
  describe file("/etc/ssh/sshd_config") do
    its("content") { should match(/^Ciphers\s.*$/) }
  end
  
  describe sshd_config do
    its('Ciphers') { should_not match(/^((3des-cbc|aes128-cbc|aes192-cbc|aes256-cbc|arcfour|arcfour128|arcfour256|blowfish-cbc|cast128-cbc|rijndael-cbc@lysator.liu.se),)*(3des-cbc|aes128-cbc|aes192-cbc|aes256-cbc|arcfour|arcfour128|arcfour256|blowfish-cbc|cast128-cbc|rijndael-cbc@lysator.liu.se)$/) }
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_5.2.14_Ensure_only_strong_MAC_algorithms_are_used" do
  ...
  impact 1.0
  describe file("/etc/ssh/sshd_config") do
    its("content") { should match(/^MACs\s.*$/) }
  end
  
  describe sshd_config do
    its('MACs') { should_not match(/^((hmac-md5|hmac-md5-96|hmac-ripemd160|hmac-sha1|hmac-sha1-96|umac-64@openssh\.com|hmac-md5-etm@openssh\.com|hmac-md5-96-etm@openssh\.com|hmac-ripemd160-etm@openssh\.com|hmac-sha1-etm@openssh\.com|hmac-sha1-96-etm@openssh\.com|umac-64-etm@openssh\.com|umac-128-etm@openssh\.com),)*(hmac-md5|hmac-md5-96|hmac-ripemd160|hmac-sha1|hmac-sha1-96|umac-64@openssh\.com|hmac-md5-etm@openssh\.com|hmac-md5-96-etm@openssh\.com|hmac-ripemd160-etm@openssh\.com|hmac-sha1-etm@openssh\.com|hmac-sha1-96-etm@openssh\.com|umac-64-etm@openssh\.com|umac-128-etm@openssh\.com)$/) }
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_5.2.15_Ensure_that_strong_Key_Exchange_algorithms_are_used" do
  ...
  impact 1.0
  describe file("/etc/ssh/sshd_config") do
    its("content") { should match(/^KexAlgorithms\s.*$/) }
  end
  
  describe sshd_config do
    its('KexAlgorithms') { should_not match(/^((KexAlgorithms diffie-hellman-group1-sha1|diffie-hellman-group14-sha1|diffie-hellman-group-exchange-sha1),)*(KexAlgorithms diffie-hellman-group1-sha1|diffie-hellman-group14-sha1|diffie-hellman-group-exchange-sha1)$/) }
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_5.2.16_Ensure_SSH_Idle_Timeout_Interval_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.17_Ensure_SSH_LoginGraceTime_is_set_to_one_minute_or_less" do
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.18_Ensure_SSH_access_is_limited" do
...
control "xccdf_org.cisecurity.benchmarks_rule_5.2.19_Ensure_SSH_warning_banner_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_5.4.1.5_Ensure_all_users_last_password_change_date_is_in_the_past" do
  ...
  "
  impact 0.0
  tag skip_reason: "Type \"time_difference\" is currently not supported"
...
control "xccdf_org.cisecurity.benchmarks_rule_5.4.2_Ensure_system_accounts_are_non-login" do
  ...
  desc  "
    There are a number of accounts provided with Amazon Linux 2 that are used to manage applications and are not intended to provide an interactive shell.
...
control "xccdf_org.cisecurity.benchmarks_rule_6.2.7_Ensure_all_users_home_directories_exist" do
  ...
  "
  impact 1.0
  passwd.where { user =~ /^(?!root|halt|sync|shutdown).*/ }.where { shell != "(\\/sbin\\/nologin|\\/usr\\/sbin\\/nologin|\\/bin\\/false)" }.homes.map { |x| x.to_s.split(":") }.flatten.each do |entry|
    describe file(entry) do
      it { should exist }
    end
  end
...
control "xccdf_org.cisecurity.benchmarks_rule_6.2.13_Ensure_users_.netrc_Files_are_not_group_or_world_accessible" do
  ...
  "
  impact 1.0
  passwd.where { user =~ /^(?!root|halt|sync|shutdown).*/ }.where { shell != "(\\/sbin\\/nologin|\\/usr\\/sbin\\/nologin|\\/bin\\/false)" }.homes.map { |x| x.to_s.split(":") }.flatten.map { |x| command("find #{x} -maxdepth 1 -type f -regex '.*/.netrc'").stdout.split }.flatten.each do |entry|
    describe file(entry) do
      it { should_not be_executable.by "group" }
    end
    describe file(entry) do
